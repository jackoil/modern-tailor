                ...
                <div class="col-lg-6 col-md-6 order-2 order-sm-2 order-md-1" style="direction: rtl;">
                    <div class="product-details-content ml-30">
                            ...
                            @if ($product->quantity_check)
                                ...
                                <div class="pro-details-quality">
                                    ...
                                    <div class="pro-details-compare">
                                        <a title="Add To Compare" href="{{ route('home.compare.index') }}"><i
                        ...
                        <div class="pro-details-meta">
                            <span>دسته بندی :</span>
                            <ul>
                                <li><a href="#">{{ $product->category->parent ? $product->category->parent->name: " " }}،
                                            ...
                                            <div class="review-content w-100 text-right">
                                                ...
                                                <div class="review-top-wrap">
                                                    <div class="review-name">
                                                        <h4> {{ $comment->user->name == null ? 'کاربر گرمی' : $comment->user->name }}
                                                        </h4>
                                                    </div>
                                                    <div data-rating-stars="5" data-rating-readonly="true"
