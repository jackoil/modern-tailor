    ...
    <div class="product-area pb-70">
        <div class="container">
            <div class="section-title text-center pb-40">
                <h2> {{ __('welcome') }}</h2>
                <p>
                    سایت سفارش گیری لباس و اموزش خیاطی
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4">
                    <div class="single-feature text-right mb-40 pl-50">
                        ...
                        <div class="feature-content">
                            {{-- <img src="https://str.tlandino.net//uploads/small_post_referral_469caf22e5.jpeg" class="sc-9f2a8ab1-8 jPiqaB"> --}}
                            <h4> کد دعوت:GWJOUY </h4>
                            <p>تترلند اولین صرافی تک نرخی تتر، با امنیت و سرعت بالا، امکان واریز آنی تتر را به کیف پول شما میسر کرده است.
                                علاوه بر این شما هم می توانید با ثبت نام و احراز هویت در کمتر از ۱۰ دقیقه، کد دعوت اختصاصی خود را دریافت کنید و با به اشتراک گذاشتن کد دعوت خود با دوستانتان از کارمزد معاملات آنها درآمد مادام العمر کسب کنید. tetherland.com را در شبکه های اجتماعی دنبال کنید.
                            <hr>
                            <p>
                                  <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="http://www.tetherland.com/register?ref=GWJOUY" >  لینک دعوت
                                  </a>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12" style="direction: rtl;">
                            <div class="product-details-content quickview-content">
                                ...
                                <div class="pro-details-meta">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#">{{ $product->category->parent ? $product->category->parent->name: ""  }}، {{ $product->category->name }}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="pro-details-meta">
