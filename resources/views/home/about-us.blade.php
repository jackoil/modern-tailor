            ...
            <div class="col-lg-6 text-right">
                <div class="story-details pl-50">
                    <div class="story-details-top">
                        <h2> خوش آمدید به  <span>  خیاطی مدرن  </span></h2>
                        <p>
              سایت سفارش گیری  لباس  و اموزش خیاطی
                    ...
                    <div class="story-details-bottom">
                        ...
                        <h4>    نحوه ی ثبت سفارش به چه صورت است؟    </h3>
                        <p>
                            ابتدا باید در سایت یا اپلیکیشن     ثبت نام کنید و یک نام کاربری به همراه رمز عبور برای خود انتخاب کنید،سپس محصول مورد نظر را انتخاب کرده و بعد از اضافه کردن آن به سبد خرید با وارد کردن آدرس دقیق،کد پستی و شماره همراه،خریدتان را نهایی کنید.
                         </p>
                    </div>
                    <div class="story-details-bottom">
                        <h4>  ارسال سفارش ها به چه صورت است       </h4>
                        <p>
                            سفارش های تهران به صورت پیک و شهرستان با پست پیشتاز صورت میگیرد.
