    ...
    <section class="banner-area1    other-page"  style=" background-image:url('{{ $bannerImage }} ')"  >
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1>    صفحه   ی  blog   </h1>
                    <a href="{{route('home.index')}}">Home</a> <span>|</span> <a href="{{route('home.blog-home')}}">Blog Home</a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        ...
                                        <a href="{{route('home.blog-detail' , ['slug'=>  $product->slug     ])}}" class="template-btn">View More</a>
                                    </div>
                                </div>
                            </div>
                        </article>
                    ...
                    @endforeach
                        <article class="row blog_item">
                           <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{ asset('images/blog/blog/main-blog/m-blog-2.jpg') }}" alt="">
                                    <div class="blog_details">
                        ...
                        <article class="row blog_item">
                           <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{ asset('images/blog/blog/main-blog/m-blog-3.jpg') }}" alt="">
                                    <div class="blog_details">
                        ...
                        <article class="row blog_item">
                           <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{ asset('images/blog/blog/main-blog/m-blog-4.jpg') }}" alt="">
                                    <div class="blog_details">
