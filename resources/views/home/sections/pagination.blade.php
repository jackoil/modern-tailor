@if ($paginator->hasPages())
    ...
    <nav class="blog-pagination justify-content-center d-flex">
        <ul class="pagination">
            ...
            @foreach ($element as $page => $url)
              @if ($page == $paginator->currentPage())
            <li  aria-current="page" class="page-item active "><a href="{{ $url."#last_blog"  }}" class="page-link">{{$page}}</a></li>
            @else
            <li   class="page-item  "><a href="{{ $url."#last_blog" }}" class="page-link">{{$page}}</a></li>
            @endif
           @endforeach
           @endforeach
            <li class="page-item">
