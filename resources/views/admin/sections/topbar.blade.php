    ...
    <ul class="navbar-nav mr-auto">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in text-right"
                ...
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">
                    ...
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{ asset('images/comment_1.png') }}" alt="">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                @else
                    <span class="ml-2 d-none d-lg-inline text-gray-600 small"> {{ ' کیومرث کپک زذه  ' }} </span>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> {!! ' آیا مایل به خروج می باشید ؟ ' !!} </div>
