            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="custom-file">
                            <input type="file" name="images[]" multiple class="custom-file-input" id="images" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="custom-file">
                            <input type="file" name="video"   class="custom-file-input" id="video" enctype="multipart/form-data">
                            <label class="custom-file-label" for="video">      انتخاب ویدیو     </label>
                        </div>
                    </div>
