        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">   تراکنش  های  یکسال   </h6>
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in text-right"
                            ...
                            <div class="dropdown-header">    گزینه ها  : </div>
                            <a class="dropdown-item" href="#">  دانلود   </a>
                            <a class="dropdown-item" href="#">  پرینت    </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#">     {{   __('detail')   }}  </a>
                        </div>
                    </div>
                </div>
                <!-- Card Body -->
